      ...
      <section className="py-16 sm:py-20 px-6 lg:px-20 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-stretch">
          <div className="flex flex-col h-full space-y-8">
            <div className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-center lg:text-left text-3xl font-bold text-secondary-dark">
                  {t("Volunteer.title")}
                </h3>
                <div className="h-1 w-16 bg-secondary rounded-sm mx-auto lg:mx-0" />
              </div>
            ...
            <div className="flex-1 flex flex-col pt-8 border-t border-secondary/10">
              <div className="flex-1 space-y-6">
                <h4 className="text-center lg:text-left text-2xl font-bold text-secondary-dark">
                  {t("Volunteer.programTitle")}
                </h4>
                <p className="text-center lg:text-left text-secondary text-base leading-relaxed">
          ...
          <div className="flex flex-col h-full space-y-8">
            ...
            <div className="flex-1 flex flex-col pt-8 border-t border-secondary/10">
              <div className="flex-1 space-y-6">
                <h4 className="text-2xl font-bold text-secondary-dark text-center lg:text-left">
                  {t("Adopt.responsibleTitle")}
                </h4>
                <p className="text-secondary text-base leading-relaxed text-center lg:text-left">
                  {t("Adopt.responsibleDescription")}
                </p>
                <p className="text-secondary text-base leading-relaxed italic text-center lg:text-left">
                  &quot;{t("Adopt.quote")}&quot;
                </p>
              </div>
              <div className="pt-8 flex items-center justify-center lg:justify-start">
